...
class Product(BaseModel):
    ...
    name = models.CharField(max_length=128)
    type = models.CharField(max_length=128,choices=(('product', 'Product'),('service', 'Service')),default="product")
    unit = models.ForeignKey(Unit,on_delete=models.CASCADE,blank=True,null=True,related_name='unit',limit_choices_to={'is_deleted':False,'is_active':True})
    description = models.TextField(blank=True,null=True)
