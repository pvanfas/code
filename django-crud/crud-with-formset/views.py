...
def create_customer(request):
    ...
    if request.method == "POST":
        ...
        customer_address_formset = CustomerAddressFormset(
            request.POST, prefix="customer_address_formset"
        )
        ...
        if form.is_valid() and customer_address_formset.is_valid():
            ...
            for f in customer_address_formset:
                ...
                CustomerAddress.objects.create(customer=data, field_name=field_name)
        ...
        form = CustomerForm()
        customer_address_formset = CustomerAddressFormset(
            prefix="customer_address_formset"
        )
        context = {
...
def edit_customer(request, pk):
    ...
    if request.method == "POST":
        ...
        customer_address_formset = CustomerAddressFormset(
            prefix="customer_address_formset", instance=instance
        )
