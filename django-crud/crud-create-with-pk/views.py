...
def create_customer(request, pk):
    instance = get_object_or_404(ModelName.objects.filter(pk=pk, is_deleted=False))
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            # model_field is the fk of ModelName
            data.model_field = instance
            data.save()
        ...
        context = {
            ...
            "form": form,
            "url": reverse("module_name:create_customer", kwargs={"pk": instance.pk}),
